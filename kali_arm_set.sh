...
sudo apt install dnsmasq urlcrazy dirsearch libreoffice bloodhound ghidra gobuster golang php-curl terminator burpsuite seclists ibus-anthy sshuttle peass jd-gui chisel -y
