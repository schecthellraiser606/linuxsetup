...
sudo apt install wine qemu-user cadaver irssi ltrace sippts pyenv jsbeautifier jq -y
sudo apt install mariadb-client-compat libfreetype6-dev ntpdate autorecon bloodyad faketime krb5-pkinit openjdk-11-jdk -y
